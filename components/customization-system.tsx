...
export const defaultLayouts: DashboardLayout[] = [
  {
    ...
    description: "Dashboard ejecutivo con métricas clave y análisis estratégico completo",
    widgets: {
  ...
  },
  {
    ...
    description: "Dashboard operacional para seguimiento y gestión diaria de pedidos",
    widgets: {
      metrics: { visible: true, position: 1, size: "medium", columns: 6 },
      charts: { visible: false, position: 2, size: "small", layout: "stack" },
  ...
  },
  {
    id: "client",
    name: "Vista Cliente",
    description: "Vista simplificada para clientes con información básica de pedidos",
    widgets: {
      metrics: { visible: false, position: 1, size: "small", columns: 8 },
      charts: { visible: false, position: 2, size: "large", layout: "grid" },
      recentOrders: { visible: true, position: 3, size: "large", rowsPerPage: 10 },
      orders: { visible: false, position: 4, size: "small", rowsPerPage: 8 },
