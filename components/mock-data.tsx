...
export const mockProducts: Product[] = [
  ...
  {
    id: "PROD002",
    name: "Plataforma de Análisis Avanzado",
    category: "Software",
    price: 8500,
    cost: 1700,
    margin: 80,
  ...
  {
    id: "PROD004",
    name: "Servidor Empresarial Dedicado",
    category: "Hardware",
    price: 25000,
    cost: 18000,
    margin: 28,
...
export const mockOrders: Order[] = [
  {
    ...
    products: ["Sistema CRM Empresarial", "Consultoría de Implementación"],
    amount: 27000,
    cost: 7800,
    margin: 71.1,
    status: "Completado",
  ...
  },
  {
    ...
    products: ["Plataforma de Análisis Avanzado", "Soporte Técnico Premium 24/7"],
    amount: 14500,
    cost: 4100,
    margin: 71.7,
    status: "Pendiente",
  ...
  },
  {
    ...
    productIds: ["PROD002"],
    products: ["Plataforma de Análisis Avanzado"],
    amount: 8500,
    cost: 1700,
    margin: 80,
    status: "Completado",
  ...
  },
  {
    ...
    productIds: ["PROD005"],
    products: ["Soporte Técnico Premium 24/7"],
    amount: 6000,
    cost: 2400,
    margin: 60,
    status: "En proceso",
  ...
  },
  {
    ...
    products: ["Sistema CRM Empresarial", "Servidor Empresarial Dedicado", "Consultoría de Implementación"],
    amount: 52000,
    cost: 25800,
    margin: 50.4,
    status: "Completado",
  ...
  },
  {
    ...
    products: ["Plataforma de Análisis Avanzado", "Consultoría de Implementación"],
    amount: 20500,
    cost: 6500,
    margin: 68.3,
    status: "Completado",
...
export const mockPromotions: Promotion[] = [
  {
    id: "PROMO001",
    name: "Descuento Empresarial Q1",
    description: "15% de descuento en Sistema CRM Empresarial para clientes Enterprise",
    type: "percentage",
    value: 15,
  ...
  {
    id: "PROMO002",
    name: "Paquete Análisis + Soporte",
    description: "Paquete especial: Plataforma de Análisis Avanzado + Soporte Técnico Premium con 20% descuento",
    type: "bundle",
    value: 20,
  ...
  {
    id: "PROMO003",
    name: "Consultoría Sin Costo",
    description: "Consultoría de implementación gratuita con compra de software superior a $20,000 MXN",
    type: "bogo",
    value: 12000,
  ...
  {
    id: "PROMO004",
    name: "Programa Startups",
    description: "30% de descuento especial para empresas emergentes en su primera compra",
    type: "percentage",
    value: 30,
    startDate: "2024-01-01",
    endDate: "2024-06-30",
  ...
  {
    id: "PROMO005",
    name: "Oferta Especial Hardware",
    description: "Descuento fijo de $5,000 MXN en servidores empresariales dedicados",
    type: "fixed",
    value: 5000,
  ...
  },
  {
    ...
    description: "14% de descuento en toda la línea de productos durante el mes de febrero",
    type: "percentage",
    value: 14,
